...
import { CATALOG_DIR, CATALOG_FILE, COVERAGE_FILE, RUN_LOG_FILE } from '../config/paths.js';
...
async function main() {
  ...
  log.blank();
  log.ok(`Catalog written: ${CATALOG_FILE}`);
  log.ok(`Coverage written: ${COVERAGE_FILE}`);
  log.blank();
}
